...
export function Staff3(props: JSX.IntrinsicElements["group"]) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes["Staff_03_Cube-Mesh"].geometry} material={materials.Iron_sword} />
      <mesh geometry={nodes["Staff_03_Cube-Mesh_1"].geometry} material={materials.Golden} />
      <mesh geometry={nodes["Staff_03_Cube-Mesh_2"].geometry} material={materials.Ball_staff_03} />
    </group>
  );
}
