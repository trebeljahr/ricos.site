...
export type GrassMaterialType = typeof GrassMaterial & Material & ShaderMaterial & typeof uniforms;
...
export const GrassMaterial = shaderMaterial(uniforms, vertShader, fragShader, (self) => {
  if (!self) return;
