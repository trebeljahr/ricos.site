...
export function Sharky(props: JSX.IntrinsicElements["group"]) {
  const group = useRef<Group>(null!);
  const { scene, animations } = useGLTF("/3d-assets/glb/enemies/Sharky-transformed.glb");
...
useGLTF.preload("/3d-assets/glb/enemies/Sharky-transformed.glb");
