...
export function InstancedRockSnow1({ positions }: { positions: Vector3[] }) {
  ...
  return (
    <GenericInstancedSystem
      ...
      modelPath={"/3d-assets/glb/nature_pack/Rock_Snow_1-transformed.glb"}
    />
  );
}
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/3d-assets/glb/nature_pack/Rock_Snow_1-transformed.glb"
