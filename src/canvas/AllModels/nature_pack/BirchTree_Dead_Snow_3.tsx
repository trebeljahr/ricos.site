...
export function InstancedBirchTreeDeadSnow3({ positions }: { positions: Vector3[] }) {
  const meshMaterialCombos: MeshMaterialCombos = [
    ["BirchTree_Dead_Snow_3_1", "White"],
    ["BirchTree_Dead_Snow_3_2", "Black"],
    ["BirchTree_Dead_Snow_3_3", "Snow"],
  ];
  ...
  return (
    <GenericInstancedSystem
      ...
      modelPath={"/3d-assets/glb/nature_pack/BirchTree_Dead_Snow_3.glb"}
    />
  );
}
