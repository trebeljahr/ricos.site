...
type GLTFResult = GLTF & {
  nodes: {
    Potion10_Filled_1: Mesh;
    Potion10_Filled_2: Mesh;
    Potion10_Filled_3: Mesh;
  };
  materials: {
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/3d-assets/glb/rpg_items_pack/Potion10_Filled.glb",
...
useGLTF.preload("/3d-assets/glb/rpg_items_pack/Potion10_Filled.glb");
