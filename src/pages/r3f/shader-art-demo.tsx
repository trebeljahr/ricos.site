...
const sidebarVariants = {
  show: (height: number) => {
    ...
    return {
      clipPath: `circle(${height * 2 + 200}px at 400px 400px)`,
      transition: {
        type: "spring",
        stiffness: 20,
        restDelta: 2,
  ...
  hidden: {
    clipPath: "circle(20px at 260px 280px)",
    transition: {
      delay: 0.2,
      type: "spring",
      stiffness: 400,
    ...
    <>
      ...
      >
        ...
        <div className="max-w-prose">
          <motion.p className="pr-5" variants={FADE_DOWN_ANIMATION_VARIANTS}>
          ...
          <motion.p className="!mb-0" variants={FADE_DOWN_ANIMATION_VARIANTS}>
            Try some presets!
          </motion.p>
