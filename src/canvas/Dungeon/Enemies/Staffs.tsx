...
export const useStaff2 = () => {
  ...
  const staffMesh = new Mesh(nodes["Staff_02_Circle001-Mesh"].geometry, materials.Iron_staff_02);

  const staffMesh2 = new Mesh(nodes["Staff_02_Circle001-Mesh_1"].geometry, materials.Wood_staff_02);

  const staffMesh3 = new Mesh(nodes["Staff_02_Circle001-Mesh_2"].geometry, materials.Green_crystal);

  const staffMesh4 = new Mesh(nodes["Staff_02_Circle001-Mesh_3"].geometry, materials.Purple_ribbon);
...
export const useStaff3 = () => {
  ...
  const staffMesh = new Mesh(nodes["Staff_03_Cube-Mesh"].geometry, materials.Iron_sword);

  const staffMesh2 = new Mesh(nodes["Staff_03_Cube-Mesh_1"].geometry, materials.Golden);

  const staffMesh3 = new Mesh(nodes["Staff_03_Cube-Mesh_2"].geometry, materials.Ball_staff_03);
...
export const useStaff4 = () => {
  ...
  const staffMesh = new Mesh(nodes["Staff_04_Circle011-Mesh"].geometry, materials.Dark_blue);

  const staffMesh2 = new Mesh(nodes["Staff_04_Circle011-Mesh_1"].geometry, materials.Iron_staff_04);
...
export const useStaff5 = () => {
  ...
  const staffMesh = new Mesh(nodes["Staff_05_Circle016-Mesh"].geometry, materials.Brown);
  const staffMesh2 = new Mesh(nodes["Staff_05_Circle016-Mesh_1"].geometry, materials.Moon);

  const staffMesh3 = new Mesh(nodes["Staff_05_Circle016-Mesh_2"].geometry, materials.Spikes);
...
export const useStaff6 = () => {
  ...
  const staffMesh = new Mesh(nodes.Skeleton_Staff.geometry, result.materials.skeleton);
