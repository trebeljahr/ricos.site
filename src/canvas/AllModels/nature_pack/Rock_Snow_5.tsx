...
export function InstancedRockSnow5({ positions }: { positions: Vector3[] }) {
  ...
  return (
    <GenericInstancedSystem
      ...
      modelPath={"/3d-assets/glb/nature_pack/Rock_Snow_5-transformed.glb"}
    />
  );
}
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/3d-assets/glb/nature_pack/Rock_Snow_5-transformed.glb"
