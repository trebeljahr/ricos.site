...
type GLTFResult = GLTF & {
  nodes: {
    Potion2_Filled_1: Mesh;
    Potion2_Filled_2: Mesh;
    Potion2_Filled_3: Mesh;
  };
  materials: {
    Glass: MeshStandardMaterial;
    Liquid_Yellow: MeshStandardMaterial;
...
useGLTF.preload("/3d-assets/glb/rpg_items_pack/Potion2_Filled.glb");
