...
export function InstancedBirchTreeAutumn2({ positions }: { positions: Vector3[] }) {
  const meshMaterialCombos: MeshMaterialCombos = [
    ["BirchTree_Autumn_2_1", "White"],
    ["BirchTree_Autumn_2_2", "Black"],
    ["BirchTree_Autumn_2_3", "LightOrange"],
    ["BirchTree_Autumn_2_4", "Orange"],
  ];
  ...
  return (
    <GenericInstancedSystem
      ...
      modelPath={"/3d-assets/glb/nature_pack/BirchTree_Autumn_2.glb"}
    />
  );
}
