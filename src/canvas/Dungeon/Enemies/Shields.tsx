...
export const useShield = () => {
  ...
  const shieldMesh = new Mesh(nodes.Skeleton_Shield_Large_A.geometry, result.materials.skeleton);
...
export const useShield2 = () => {
  ...
  const shieldMesh = new Mesh(nodes.Skeleton_Shield_Small_B.geometry, result.materials.skeleton);
...
export const useShield3 = () => {
  ...
  const shieldMesh = new Mesh(nodes.Skeleton_Shield_Small_A.geometry, materials.skeleton);
...
export const useShield4 = () => {
  ...
  const shieldMesh = new Mesh(nodes.Skeleton_Shield_Large_B.geometry, materials.skeleton);
