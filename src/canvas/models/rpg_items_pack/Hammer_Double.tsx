  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        <mesh
          geometry={nodes.Hammer_Double_1.geometry}
          material={materials.Steel}
        />
        <mesh
          geometry={nodes.Hammer_Double_2.geometry}
          material={materials.LightSteel}
        />
        <mesh
          geometry={nodes.Hammer_Double_3.geometry}
          material={materials.DarkWood}
        />
        <mesh
          geometry={nodes.Hammer_Double_4.geometry}
