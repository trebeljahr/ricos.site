...
export function InstancedCommonTreeDead3({
  ...
  return (
    <GenericInstancedSystem
      ...
      modelPath={"/3d-assets/glb/nature_pack/CommonTree_Dead_3-transformed.glb"}
    />
  );
}
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/3d-assets/glb/nature_pack/CommonTree_Dead_3-transformed.glb"
